...
const slice = createSlice({
    ...
    extraReducers: {
      ...
      [playlistsAsyncActions.deletePlaylist.fulfilled.type]: (state) => {
        state.notifications.push({
        id: getId(),
        message: 'playlist_deleted',
        severity: SEVERITY.Info,
        })
      },
      [playlistsAsyncActions.deletePlaylist.rejected.type]: (state, action) => {
          state.notifications.push({
          id: getId(),
          message: action.payload,
          severity: SEVERITY.Error,
      ...
      [playlistsAsyncActions.deleteSong.rejected.type]: (state, action) => {
        state.notifications.push({
        id: getId(),
        message: action.payload,
        severity:  SEVERITY.Error,
      ...
      [playlistsAsyncActions.vote.rejected.type]: (state, action) => {
        state.notifications.push({
        id: getId(),
        message: action.payload,
        severity:  action.payload === 'database_error'? SEVERITY.Error : SEVERITY.Warning,
